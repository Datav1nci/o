  ...
  return (
    <main className="container mx-auto max-w-6xl px-4 py-10">
      ...
      <nav className="mb-6 text-sm text-slate-500">
        <Link href="/filtre_pour_toute_la_maison" className="hover:underline">Filtre pour toute la maison</Link>
      ...
      <div className="mt-10 grid gap-10 rounded-2xl border border-gray-100 bg-gray-50 p-6 md:grid-cols-2">
          ...
          <div className="mt-4 overflow-x-auto">
            <table className="w-full min-w-[480px] text-sm">
              <tbody className="[&_tr:nth-child(odd)]:bg-white/60">
                <tr><td className="px-3 py-2 font-medium">Nom du produit</td><td className="px-3 py-2">Protecteur / Énergie</td></tr>
                <tr><td className="px-3 py-2 font-medium">Dimensions</td><td className="px-3 py-2">4.5×20 in / 2.5×10 in</td></tr>
                <tr><td className="px-3 py-2 font-medium">Débit maximal</td><td className="px-3 py-2">25 L/min / 15 L/min</td></tr>
                <tr><td className="px-3 py-2 font-medium">Pression max.</td><td className="px-3 py-2">&lt; 8 bar / &lt; 5 bar</td></tr>
                <tr><td className="px-3 py-2 font-medium">Capacité</td><td className="px-3 py-2">427 000 L / 56 000 L</td></tr>
                <tr><td className="px-3 py-2 font-medium">Volume (2 ppm)</td><td className="px-3 py-2">213 500 / 28 000</td></tr>
              </tbody>
            </table>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-slate-700">
            <li>✔︎ Encombrement réduit : 1 pot unique au lieu d’une station duplex</li>
            <li>✔︎ Entretien simplifié : 1 seule cartouche à remplacer</li>
      ...
      <div className="mt-10 grid gap-10 md:grid-cols-2">
        <div>
          ...
          <ul className="mt-4 list-disc space-y-2 pl-5 text-slate-700">
            ...
            <li>Cartouche Nü-Blend : manchon 10 µm + conteneur de média en grains</li>
        ...
        <div>
          ...
          <p className="mt-4 text-slate-700">
            Conteneur composé de Nü-Blend en grains. Remplacement recommandé : tous les 12 mois.
          </p>
        </div>
      </div>
      ...
      <div className="mt-10 grid gap-8 md:grid-cols-2">
        <div className="relative aspect-video overflow-hidden rounded-2xl border border-gray-200">
          ...
          <Image src="/images/distribution.png" alt="Illustration de l’installation" fill className="object-contain" />
        </div>
        <div className="relative aspect-video overflow-hidden rounded-2xl border border-gray-200">
          {/* TODO: replace with your real photo */}
          <Image src="/images/drinking.png" alt="Photo d’installation" fill className="object-cover" />
        </div>
      </div>
